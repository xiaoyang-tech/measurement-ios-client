...
class CameraFeedService: NSObject {
  ...
  private let sessionQueue = DispatchQueue(label: "com.xiaoyang.CameraFeedService.sessionQueue")
  ...
  private func addVideoDeviceInput() -> Bool {
    ...
    guard let camera  = AVCaptureDevice.default(.builtInWideAngleCamera, for: .video, position: cameraPosition) else {
      ...
      for _ in camera.activeFormat.videoSupportedFrameRateRanges {}
  ...
  private func addVideoDataOutput() -> Bool {
    ...
    let sampleBufferQueue = DispatchQueue(label: "com.xiaoyang.CameraFeedService.sampleBufferQueue")
