        ...
        GeometryReader { geo in
            ...
            ZStack {
                ForEach(labels, id: \.self) { value in
                    ...
                    let color: Color = {
                        switch value {
                        case 0, 20, 40: return Severe_unhealthiness_color
                        case 60:        return Mild_unhealthiness_color
                        case 80:        return Good_color
                        case 100:       return Excellent_color
                        default:        return .gray
                        }
                    }()
                    Text("\(value)")
